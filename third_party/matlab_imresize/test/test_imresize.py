...
print(f'Python/MatLab uint8 diff: min ={np.amin(diff_uint8)} max={np.amax(diff_uint8)}')
print(f'Python/Matlab double diff: min={np.amin(diff_double)} max={np.amax(diff_double)}')
